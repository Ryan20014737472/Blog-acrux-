...
export function TeamPreviewCards() {
  ...
  return <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
    ...
    {loaded && !members.length ? <div className="glass-panel rounded-2xl border-l-2 border-l-acrux-cyan p-6 sm:col-span-2 sm:p-8 lg:col-span-3"><p className="text-lg font-bold text-white">Os perfis em destaque aparecerão aqui</p><p className="mt-2 text-sm leading-6 text-acrux-muted">A equipe poderá escolher até três integrantes para esta área.</p><ArrowLink className="mt-5" href="/equipe">Ver a equipe</ArrowLink></div> : null}
  </div>;
}
